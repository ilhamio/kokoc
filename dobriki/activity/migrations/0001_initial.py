    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coeff', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Коэффициент')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aim', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
                'verbose_name': 'Цель',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.IntegerField(verbose_name='Время')),
                ('kcal', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Калории')),
                ('activity', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='activity.activity', verbose_name='Активность')),
            ],
            options={
